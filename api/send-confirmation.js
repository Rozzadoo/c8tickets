...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: 'Crooked 8 Tickets <noreply@c8tickets.com>',
        ...
        <body style="margin:0;padding:0;background:#0c0a07;font-family:'Helvetica Neue',Arial,sans-serif">
          <div style="max-width:520px;margin:0 auto;padding:40px 20px">
            ...
            <div style="text-align:center;font-size:11px;color:#7a6c54;line-height:1.8">
              Questions? Call us at <strong style="color:#b5a78a">(208) 991-0788</strong><br>
              1882 E King Rd, Kuna, ID 83634<br>
              <a href="https://crooked8.com" style="color:#c8922a">crooked8.com</a>
            </div>
