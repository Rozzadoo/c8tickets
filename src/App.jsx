                  ...
                  {displayTickets.map((t) => {
                    ...
                    return (
                      <div key={t.id} className="tkt-disp" style={{marginBottom:20,pageBreakInside:'avoid'}}>
                        ...
                        {/iPhone|iPad|iPod/.test(navigator.userAgent) && <a href={`${API_BASE}/api/wallet-pass?id=${t.id}`} style={{display:"block",marginTop:8,background:"#000",color:"#fff",borderRadius:8,padding:"10px 0",textAlign:"center",textDecoration:"none",fontSize:13,fontWeight:600,letterSpacing:.3}}>🍎 Add to Apple Wallet</a>}
                      </div>
                    );
                  })}
                </div>
